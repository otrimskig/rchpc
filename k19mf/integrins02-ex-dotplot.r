...
int<-readRDS("k19mf/ds/int-pvals-ex.rds")
...
ggsave(paste0("k19mf/plots/", "hm-integrins-dotplots-ex.pdf"),
       plot=plot_grid,
       height=18,
       width=4,
       scale = 2.5,
...
write_csv(df, "k19mf/ds/int_pvals-ex.csv")
write_csv(df2, "k19mf/ds/int_pvals2-ex.csv")
