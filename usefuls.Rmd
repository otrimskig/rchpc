...
how to save a ggplot or other grob to pdf. This below is useful because
it adds a title to the metadata of the pdf file, which prints the R
script path and date-time of generation.
