...
gsva_z_sig<-readRDS("nf1g/ds/gsva_sig_z-onco.rds")

gsva_u<-readRDS("nf1g/ds/gsva_u-onco.rds")
gsva_z<-readRDS("nf1g/ds/gsva_z-onco.rds")
...
saveRDS(summary_stats, "nf1g/ds/gsva_pathway_stats-onco.rds")
